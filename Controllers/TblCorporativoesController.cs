    ...
    public class TblCorporativoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCorporativo,IdTipoLicencia,IdTipoCorporativo,NombreCorporativo,Calle,CodigoPostal,IdColonia,Colonia,LocalidadMunicipio,Ciudad,Estado,CorreoElectronico,Telefono,IdEmpresa,FechaRegistro,IdEstatusRegistro")] TblCorporativo tblCorporativo)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    var vDuplicado = _context.TblCorporativos
                    ...
                    if (vDuplicado.Count == 0)
                    {
                        ...
                        tblCorporativo.Colonia = !string.IsNullOrEmpty(tblCorporativo.Colonia) ? strColonia.Dasenta.ToUpper().Trim() : tblCorporativo.Colonia;
                        tblCorporativo.Calle = !string.IsNullOrEmpty(tblCorporativo.Calle) ? tblCorporativo.Calle.ToUpper().Trim() : tblCorporativo.Calle;
                        tblCorporativo.LocalidadMunicipio = !string.IsNullOrEmpty(tblCorporativo.LocalidadMunicipio) ? tblCorporativo.LocalidadMunicipio.ToUpper().Trim() : tblCorporativo.LocalidadMunicipio;
                        tblCorporativo.Ciudad = !string.IsNullOrEmpty(tblCorporativo.Ciudad) ? tblCorporativo.Ciudad.ToUpper().Trim() : tblCorporativo.Ciudad;
                        tblCorporativo.Estado = !string.IsNullOrEmpty(tblCorporativo.Estado) ? tblCorporativo.Estado.ToUpper().Trim() : tblCorporativo.Estado;
